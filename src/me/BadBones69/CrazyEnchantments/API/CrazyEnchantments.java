...
public class CrazyEnchantments {
	 ...
	 * 
	 * @param enchantment
	 *            The enchantment you wish to get the category from.
	 * @return Returns the category of the enchantment that goes on an item.
	 */
	public String getEnchantmentCategory(CEnchantments enchantment) {
		return Main.settings.getEnchs().getString("Enchantments." + enchantment.getName() + ".Categories");
	}
