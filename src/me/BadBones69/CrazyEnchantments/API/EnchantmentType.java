...
public enum EnchantmentType {
	ARMOR("Armor", isArmor()), CHESTPLATE("Chestplate", isChestplate()), LEGGINGS("Leggings", isLeggings()), AXE("Axe",
			isAxe()), BOW("Bow", isBow()), BOOTS("Boots", isBoots()), HELMET("Helmet", isHelmet()), SWORD("Sword",
					isSword()), WEAPONS("Weapons",
							isWeapon()), PICKAXE("PickAxe", isPickAxe()), TOOL("Tool", isTool()), ALL("All", isAll());
